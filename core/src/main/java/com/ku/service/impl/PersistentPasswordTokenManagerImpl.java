...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.ku.service.impl.PasswordTokenManager#generateRecoveryToken(com.ku.model.User)
     */
    @Override
    ...
    /**
     * @see com.ku.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.ku.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.ku.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
