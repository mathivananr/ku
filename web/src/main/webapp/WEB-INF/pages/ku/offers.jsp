						...
						<div id="offer-image" class="offer-image">
							<c:choose>
							  <c:when test="${not empty offer.imagePath}">
							    <div class="text-center"><a href="${offer.targetURL}" ><img style="max-height: 150px;" class="col-lg-12 col-md-12 col-sm-10 col-xs-10" alt="${offer.merchantName}" data-src = "${offer.imagePath}" src=""></a></div>
							  </c:when>
